...
import { Bot, TrendingUp, Upload } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Bollinger Bands Trading Bot</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome to Bollinger Bands Trading Bot</h2>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center mb-12">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Bollinger Bands Strategy</h3>
